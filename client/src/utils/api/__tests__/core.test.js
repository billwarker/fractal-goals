...
describe('api core auth refresh behavior', () => {
    ...
    it('attaches CSRF headers to every protected mutating API helper', async () => {
        ...
        const protectedMutations = [
            ...
            ['admin.updateTierQuotas', () => adminApi.updateTierQuotas({ tier: 'free', limits: { goals: 100 }, storage_limit_bytes: 104857600, apply_existing_users: false })],
            ...
            ['activities.createActivityTagCatalogItem', () => fractalActivitiesApi.createActivityTagCatalogItem('root-1', { name: 'Competition', scope: 'selected', activity_ids: ['activity-1'] })],
            ['activities.updateActivityTagCatalogItem', () => fractalActivitiesApi.updateActivityTagCatalogItem('root-1', 'definition-1', { version: 1, name: 'Meet' })],
            ['activities.archiveActivityTagCatalogItem', () => fractalActivitiesApi.archiveActivityTagCatalogItem('root-1', 'definition-1', 1)],
            ['activities.restoreActivityTagCatalogItem', () => fractalActivitiesApi.restoreActivityTagCatalogItem('root-1', 'definition-1', 2)],
            ['activities.hardDeleteActivityTagCatalogItem', () => fractalActivitiesApi.hardDeleteActivityTagCatalogItem('root-1', 'definition-1', { version: 2, confirmation_name: 'Meet' })],
            ['activities.mergeActivityTagCatalogItems', () => fractalActivitiesApi.mergeActivityTagCatalogItems('root-1', { target_id: 'definition-1', source_ids: ['definition-2'], versions: { 'definition-1': 2, 'definition-2': 1 } })],
            ['activities.previewActivityTagCatalogMerge', () => fractalActivitiesApi.previewActivityTagCatalogMerge('root-1', { target_id: 'definition-1', source_ids: ['definition-2'], versions: { 'definition-1': 2, 'definition-2': 1 } })],
            ...
            ['activities.updateActivityProgressView', () => fractalActivitiesApi.updateActivityProgressView('root-1', 'activity-1', 'view-1', { version: 1 })],
            ['activities.deleteActivityProgressView', () => fractalActivitiesApi.deleteActivityProgressView('root-1', 'activity-1', 'view-1')],
            ['activities.activateActivityProgressView', () => fractalActivitiesApi.activateActivityProgressView('root-1', 'activity-1', 'view-1')],
