...
export const normalizeGoalNode = (goal, options = {}) => {
    ...
    return {
        ...
        paused: Boolean(goal.paused ?? goal.attributes?.paused ?? goal.frozen ?? goal.attributes?.frozen),
        paused_at: goal.attributes?.paused_at ?? goal.paused_at ?? goal.attributes?.frozen_at ?? goal.frozen_at ?? null,
        frozen: Boolean(goal.paused ?? goal.attributes?.paused ?? goal.frozen ?? goal.attributes?.frozen),
        frozen_at: goal.attributes?.paused_at ?? goal.paused_at ?? goal.attributes?.frozen_at ?? goal.frozen_at ?? null,
