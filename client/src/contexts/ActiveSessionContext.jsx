...
export function QueuedQuickSessionProvider({
    ...
    const actionsValue = useMemo(() => ({
        ...
        updateInstance,
        updateTimer: () => {},
        duplicateActivityInstance: async () => null,
        clearActivityInstanceValues: async () => null,
        copyActivityValuesFromSource: async () => null,
        copyActivityValuesFromInstance: async () => null,
