...
export default function CircuitBuilderModal({ isOpen, onClose, circuit, isCopy = false, activities, activityGroups, onSave, isSaving }) {
    ...
    return (
        <Modal isOpen={isOpen} onClose={onClose} title={circuit && !isCopy ? 'Edit Circuit' : 'Create Circuit'} size="lg">
            <ModalBody>
                <div className={styles.form}>
                    <label>
                        <span>Name</span>
                        <input value={draft.name} maxLength={255} onChange={(event) => setDraft({ ...draft, name: event.target.value })} />
                    </label>
                    <label>
                    ...
                    <div className={styles.slotHeader}>
                        ...
                        <Button type="button" variant="secondary" onClick={() => setShowActivitySelector(true)}>
                            + Add Activity
                        </Button>
                    </div>
            ...
            <ModalFooter>
                ...
                <Button variant="primary" onClick={submit} disabled={isSaving}>{isSaving ? 'Saving…' : 'Save Circuit'}</Button>
            </ModalFooter>
        </Modal>
    );
}
