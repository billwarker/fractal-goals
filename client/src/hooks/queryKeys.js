export const queryKeys = {
    aiConnections: () => ['ai-agent', 'connections'],
    aiContext: (rootId) => ['ai-agent', 'context', rootId],
    aiTasks: (rootId = null) => ['ai-agent', 'tasks', rootId],
    aiTaskProposals: (taskId) => ['ai-agent', 'task-proposals', taskId],
    aiRuns: (rootId = null) => ['ai-agent', 'runs', rootId],
    aiChangeCursor: (rootId) => ['ai-agent', 'changes', rootId],
    aiEmbeddedProviders: () => ['ai-agent', 'embedded-providers'],
    ...
    activeSessionRoot: () => ['sessions', 'active'],
    activeSession: (userId, rootId) => ['sessions', 'active', userId, rootId],
    ...
    goalNotes: (rootId, goalId, filters = {}) => ['goal-notes', rootId, goalId, filters],
    ...
    activityProgressTimeline: (rootId, activityId, sessionId = null) => [
        'activity-progress-timeline', rootId, activityId, sessionId,
    ],
};
