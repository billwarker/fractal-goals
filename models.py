...
class ActivityInstance(Base):
    ...
    def to_dict(self):
        ...
        return {
            ...
            "time_start": self.time_start.isoformat(timespec='seconds') if self.time_start else None,
            "time_stop": self.time_stop.isoformat(timespec='seconds') if self.time_stop else None,
