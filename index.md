...
- `planning/`: active implementation plans, visual specifications, and readiness audits, including `planning/beta-readiness-2026-07.md`, `planning/beta-readiness-findings-2026-07.md`, and the standalone 35-candidate basic/SMART icon comparison sheet at `planning/goal-icon-expansion-spec-2026-07.html`
